...
import static models.Inventory.updateProduct;
import static controllers.MainScreenController.modifyProduct;
import static controllers.MainScreenController.modifyProductIndex;
import static models.Inventory.lookupPart;
import models.Part;
import models.Product;
import static models.Product.getAllAssociatedParts;
...
public class ModifyProductController implements Initializable {
    ...
    public void saveProductButtonPushed(ActionEvent event) throws IOException{
        ...
        if(productStock < min || productStock > max){
            ...
            Product updateProduct = new Product(modifyProduct.getProduct_id(), productName, productPrice, productStock, min, max);
            updateProduct.associatedParts = productParts;
            updateProduct(modifyProductIndex, updateProduct);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        productIDTextField.setText("Auto gen: " + Integer.toString((modifyProduct.getProduct_id())));
        productNameTextField.setText(modifyProduct.getName());
        productInventoryTextField.setText(Integer.toString(modifyProduct.getStock()));
        productPriceTextField.setText(Double.toString(modifyProduct.getPrice()));
        productMaxTextField.setText(Integer.toString(modifyProduct.getMax()));
        productMinTextField.setText(Integer.toString(modifyProduct.getMin()));
        productParts = getAllAssociatedParts(modifyProduct);
